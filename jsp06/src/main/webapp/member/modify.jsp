        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <th>전화번호</th>
                    <td>
                        <input type="text" name="userHp" id="userHp" placeholder="전화번호를 입력해 주세요.">
                    </td>
                </tr>
                <tr>
                    <th>주소</th>
                    <td>
                        <div>
                            <input type="text" name="userZipcode" id="userZipcode" placeholder="우편번호를 입력해 주세요." readonly>
                            <button class="btn zipCode">우편번호 찾기</button>
                        </div>
                        <div>
                            <input type="text" name="userAddr01" id="userAddr01" placeholder="기본 주소를 입력해 주세요.">
                            <span>기본 주소</span>
                        </div>
                        <div>
